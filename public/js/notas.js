...
function renderNotasProfesor(cont) {
    ...
    // Botón 'Aula completa' — habilitar solo si grado+sección están seleccionados
...
function buscarNotas() {
    ...
    const estudiantes = getEstudiantes();
        // Mostrar todos los estudiantes que cumplan el filtro, incluyendo los ya seleccionados
    ...
    // ✅ AGREGADO: index para animación escalonada
